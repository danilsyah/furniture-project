        ...
        <div class="flex -mx-4 flex-row relative">
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="{{url('/frontend/images/content/image-arrived-1.png')}}"
                alt=""
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="{{url('/frontend/images/content/image-arrived-2.png')}}"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="{{url('/frontend/images/content/image-arrived-3.png')}}"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="{{url('/frontend/images/content/image-arrived-4.png')}}"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="{{url('/frontend/images/content/image-arrived-5.png')}}"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
